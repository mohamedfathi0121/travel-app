  ...
  return (
    <section className="bg-background p-4 rounded-lg shadow-md mb-4 text-left border border-gray-200 dark:border-blue-900 dark:shadow-[0_4px_32px_0_rgba(0,40,120,0.25)]">
      ...
      <ul className="list-disc pl-6 space-y-1 text-text-hard-secondary">
        ...
        <li>
          Children from 0 to 5.99 years old stay free of charge (no extra bed).
        </li>
        <li>
          First child from 6.00 to 11.99 years old stays free of charge (no
          extra bed).
        </li>
        <li>
          Second child from 6.00 to 11.99 years old gets 50% off adult rate
          (with extra bed).
        </li>
